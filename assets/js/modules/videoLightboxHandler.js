...
export function initVideoLightboxHandler(lightbox, videoMeshes, DOM_VIDEOS, canvas, getCurrentIntersect) {
  let videobox = null;
  ...
  function createVideo(url) {
      ...
      tl.to(".lightbox", { opacity: 1, zIndex: 999, duration: 0.5 })
        .from(".videobox", { opacity: 0, zIndex: 0, duration: 0 });
...
export function initLightboxHandlers(lightbox, imgObjects, videoMeshes, DOM_VIDEOS, canvas, getCurrentIntersect) {
